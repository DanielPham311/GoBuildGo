  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-7xl px-6 py-8">
        ...
        {components.length === 0 ? (
          <p className="text-muted-foreground">No components recommended for this theme.</p>
        ) : (
      ...
      <section className="border-t bg-muted/20">
        <div className="mx-auto max-w-7xl px-6 py-12 text-center">
          <h2 className="text-xl font-bold mb-2">Use Theme in Planner</h2>
          <p className="text-muted-foreground mb-6">
            Auto-fill your planner with components matching this theme.
          </p>
          <Link
